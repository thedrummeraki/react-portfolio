...
export default function PrivacyPolicy() {
  return (
    <SectionContainer
      title="Dexify - Privacy Policy"
      breadcrumbs={[{ url: "/", text: "Home" }]}
    >
      <div className={z`display flex; justify-content center`}>
        <div className={z`text-align start; max-width 900`}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Dexify.
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            <li>
              By email:{" "}
              <a className={z`color #fff`} href="mailto:privacy@akinyele.ca">
                privacy@akinyele.ca
              </a>
            </li>
          </ul>
